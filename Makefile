#
# "$Id: Makefile,v 1.31.2.8 2002/03/22 15:47:15 mike Exp $"
#
...
DIRS	=	ipp cups backend berkeley cgi-bin filter man pdftops \
		scheduler systemv
...
#
# End of "$Id: Makefile,v 1.31.2.8 2002/03/22 15:47:15 mike Exp $".
#
