/*
 * "$Id: client.h,v 1.1 1999/02/09 22:04:11 mike Exp $"
 *
...
extern int	SendCommand(client_t *con, http_status_t code, char *command, char *type);
...
/*
 * End of "$Id: client.h,v 1.1 1999/02/09 22:04:11 mike Exp $".
 */
