              ...
              cups_dest_t **dests)	/* O - Destinations */
{
  ...
  */
  ...
  num_dests = _cupsGetDests(http, CUPS_GET_PRINTERS, NULL, num_dests, dests);
                 ...
                 const char *instance)	/* I - Instance name or @code NULL@ */
{
  ...
  */
  ...
  if (!_cupsGetDests(http, op, name, 0, &dest))
  {
    ...
    */
    ...
    if (!_cupsGetDests(http, CUPS_GET_DEFAULT, NULL, 0, &dest))
      return (NULL);
  }
              ...
              cups_dest_t *dests)	/* I - Destinations */
{
  ...
  */
  ...
  num_temps = _cupsGetDests(http, CUPS_GET_PRINTERS, NULL, 0, &temps);
