/*
 * "$Id: ppd.c,v 1.51.2.11 2002/05/09 03:24:04 mike Exp $"
 *
  ...
  *string = NULL;
  ...
  do
  {
	...
	*lineptr++ = ch;
    ...
    printf("END OF LINE, lineptr - line = %d, ch = %x, endquote = %d\n",
           lineptr - line, ch, endquote);
...
/*
 * End of "$Id: ppd.c,v 1.51.2.11 2002/05/09 03:24:04 mike Exp $".
 */
